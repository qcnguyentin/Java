...
public class Main {
	public static void main(String[] args) throws ParseException, ClassNotFoundException {
		...
		Promotion pr1 = new PromotionA("11/11/2020", "11/1/2022", 20);
		Promotion pr2 = new PromotionB("11/11/2021", "12/1/2022");//in ra
		...
		List<Promotion> kq4 = new ArrayList<Promotion>();
		System.out.println("!!!!!!");
		kq4 = p1.xDayToOut(4);
		kq4.forEach(h->h.show());
		// menu ->
	}
}
